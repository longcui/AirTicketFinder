...
//                    for (CITY momondoFromNorwayPlace : CITY.values()) {
...
//                                for (CITY momondoToNorwayPlace : CITY.values()) {
//                                    FinnNorwayPlace finnToNorwayPlace = FinnNorwayPlace.valueOf(momondoToNorwayPlace.name());
//                                    String momondoURLString = getMomondoURLString(momondoFromNorwayPlace.getIataCode(), momondoToChinaPlace.getCode(), momondoFromChinaPlace.getCode(), momondoToNorwayPlace.getIataCode(), from, to);
